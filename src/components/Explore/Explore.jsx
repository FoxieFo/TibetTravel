        ...
        <section className={s.explore__container}>
            <div className={s.explore__content}>
                <div className={s.explore__media}>
                    <div
                        className={`${s.explore__mediaVideo} ${activeImg === 'mountains' ? s.active : ''
                            }`}
                        onClick={() => handleActiveImg('mountains')}
                    >
                    ...
                    <div
                        className={`${s.explore__mediaVideo} ${activeImg === 'village' ? s.active : ''
                            }`}
                        onClick={() => handleActiveImg('village')}
                    >
                ...
                <div className={s.explore__info}>
                    ...
                    <h1 className={s.explore__infoExplore}>
                        Explore all the mountain ranges of the world with us
                    </h1>
